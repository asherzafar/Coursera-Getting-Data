...
This repo contains the tidy data set for the course project, as well as the analysis code to produce this set from the source files.

#Files in this repo
The following other files are in this repo:
1) AveragesBySubjectAndActivity.txt - the tidy data set required for the project.
2) run_analysis.R - the script required to produce this data set from the source files.
